...
4. Extend the reviewed accounting-link/subledger reconciliation gate from the
   ...
   source-to-journal links and investment performance/valuation links remain
   to be reconciled. Opening receivable/payable recognition links are covered.
...
6. Complete a reviewed external benchmark/performance cohort and extend the
   ...
   benchmark-reconciliation evidence with exact parity/replay; source-feed
