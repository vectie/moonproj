...
The current scaffold has 233 passing MoonBit tests across the new packages. The
...
3. Complete remaining cross-domain persistence links: workflow assignment
   SLA/escalation semantics and CBS configuration. Typed workflow-assignment
