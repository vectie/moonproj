...
- Target states: `{"connected_admin_audit_read": 1, "connected_admin_error_read": 1, "connected_admin_health_read": 1, "connected_admin_ocr_read": 1, "connected_admin_read": 1, "connected_ai_hub_read": 1, "connected_ai_stats_read": 1, "connected_attachment_read": 1, "connected_cashflow_read": 1, "connected_cbs_read": 4, "connected_command_form": 1, "connected_contract_command_form": 1, "connected_contract_read": 1, "connected_cost_dashboard_read": 1, "connected_cost_read": 1, "connected_dashboard_read": 3, "connected_delivery_command_form": 2, "connected_expense_detail_read": 1, "connected_expense_read": 1, "connected_fund_read": 1, "connected_investment_read": 1, "connected_investment_command_candidate": 0, "connected_report_export_xlsx": 1, "connected_invoice_read": 1, "connected_loan_command_form": 2, "connected_loan_read": 1, "connected_marketing_read": 1, "connected_notification_read": 2, "connected_payment_application_command_form": 1, "connected_profile_read": 1, "connected_project_read": 2, "connected_rbac_user_read": 1, "connected_report_builder_command_form": 1, "connected_report_read": 1, "connected_sales_read": 5, "connected_supplier_command_form": 1, "connected_supplier_read": 1, "connected_supplier_risk_read": 1, "connected_tender_command_form": 1, "connected_warning_command_form": 1, "connected_warning_read": 1, "connected_webhook_read": 1, "connected_workflow_definition_read": 1, "public": 1, "read_only_public": 1}`
- API states: `{"connected_admin_audit_read": 1, "connected_admin_error_read": 1, "connected_admin_health_read": 1, "connected_admin_ocr_read": 1, "connected_admin_read": 1, "connected_ai_hub_read": 1, "ai_hub_explain_candidate": 1, "ai_hub_command_candidate": 9, "connected_ai_stats_read": 1, "connected_ai_stats_badge_batch_read": 1, "connected_attachment_read": 1, "attachment_re_extract_candidate": 1, "attachment_upload_candidate": 1, "attachment_delete_candidate": 1, "connected_cashflow_read": 1, "connected_cashflow_ai_explain_candidate": 1, "connected_cbs_read": 4, "connected_cbs_command_candidate": 5, "connected_cbs_approval_command_candidate": 3, "connected_contract_command": 2, "connected_cost_dashboard_read": 1, "connected_cost_read": 1, "connected_dashboard_read": 3, "connected_delivery_command": 2, "connected_expense_command": 1, "connected_expense_detail_read": 1, "connected_expense_read": 1, "connected_fund_read": 1, "connected_investment_read": 1, "connected_investment_ai_explain_candidate": 1, "investment_excel_index_upsert_candidate": 1, "investment_excel_plan_line_import_candidate": 1, "investment_subject_mappings_candidate": 1, "investment_plan_line_update_candidate": 1, "investment_excel_upload_candidate": 1, "connected_invoice_read": 1, "connected_loan_command": 2, "connected_loan_workflow_sync_candidate": 1, "connected_loan_read": 1, "connected_marketing_read": 1, "connected_notification_read": 2, "connected_notification_config_command_candidate": 1, "connected_notification_webhook_test_candidate": 1, "connected_notification_email_command_candidate": 2, "connected_ai_provider_test_candidate": 3, "connected_notification_digest_dispatch_candidate": 1, "connected_payment_application_command": 1, "connected_profile_read": 1, "connected_project_read": 2, "plan_ai_suggestion_candidate": 1, "connected_rbac_user_command_candidate": 4, "connected_rbac_role_command_candidate": 2, "connected_rbac_role_assignment_candidate": 1, "connected_rbac_user_read": 1, "connected_report_builder_command": 1, "connected_report_read": 1, "connected_sales_read": 5, "connected_supplier_command": 1, "connected_supplier_read": 1, "connected_supplier_risk_read": 1, "connected_supplier_rescore_command": 1, "connected_tender_command": 1, "connected_warning_command": 1, "connected_warning_custom_rule_command_candidate": 2, "connected_warning_custom_rule_preview_candidate": 1, "connected_warning_read": 1, "connected_warning_rule_command_candidate": 1, "connected_warning_scan_preview_read": 1, "connected_warning_ticket_command_candidate": 1, "connected_warning_ticket_transition_candidate": 3, "connected_webhook_config_command_candidate": 1, "connected_webhook_test_delivery_candidate": 1, "connected_webhook_overdue_scan_candidate": 1, "connected_webhook_overdue_preview_read": 1, "connected_webhook_read": 1, "connected_workflow_definition_read": 1, "connected_admin_sys_param_command_candidate": 1, "connected_auth_command_candidate": 4, "read_only_fixture_no_source_api": 1}`
...
- API-state delta: `connected_import_batch_command_candidate` **1** covers project and contract command paths; customer deletion now uses the native command-owned tombstone with imported-row protection. The API-state JSON ledger remains authoritative.
- Browser action delta: the trusted native gateway now forwards project/contract import templates and batch commands; Rabbita Projects/Contracts expose CSV selection, five-row preview, dry-run validation, and commit through the authenticated route. Contract import uses the same allow-listed boundary; production identity and owner acceptance remain separate gates.
- Browser action delta: Rabbita `/sales/customers` now loads project/keyword-filtered source rows, mirrors the source create/edit form, and exposes edit/delete controls only for command-owned customer projections; imported customers remain read-only. Customer delete still follows the gateway's archive/approval boundary.
- Browser action delta: Rabbita `/sales/subscriptions` continues to call the native local reservation candidate; conversion and downstream sales/finance effects remain gated.
...
- Browser action delta: Rabbita `/ai-hub` now mirrors the source intake/query surface with description, business-type, file-name, and natural-language question fields; intake/query/session requests carry those values to the same native non-provider authorization gate.
- Browser action delta: Rabbita `/ocr-config` now exposes native OCR, admin-LLM, and notification-LLM provider-test candidates; each records redacted dry-run evidence without invoking a provider or returning credentials.
- Browser action delta: Rabbita `/notify-config` now exposes the source-shaped subscription form (rule, business, severity, channels, enabled) and a full channel/SMTP/LLM/digest/ticket configuration form. Subscription creation and configuration save build dynamic PostgreSQL command candidates; secrets remain write-only, imported rows remain read-only, and no provider or delivery effect is enabled. Email test and redelivery candidates retain the trusted gateway redaction and missing-imported-row boundaries.
- Browser action delta: Rabbita `/inbox` now mirrors the source unread/read/all tabs, filters the PostgreSQL message read model by status, and exposes per-message `标已读` plus `全部已读` command candidates. Imported messages remain immutable; read overlays are refreshed through the native source alias with no delivery/provider effect.
- Browser action delta: Rabbita `/admin` now exposes the PostgreSQL backup boundary; it reports target-format/gated evidence without MySQL tooling or binary export.
...
- Browser action delta: Rabbita `/investment` now mirrors the source Excel import surface (`.xlsx` picker, version name, activation toggle) and calls the native workbook upload gate; binary parsing, import persistence, valuation, and financial effects remain disabled.
- Browser action delta: Rabbita `/investment` now loads and renders source Excel import history (file/version/workbook metadata and status); workbook binary content and import persistence remain disabled.
- Browser action delta: Rabbita `/investment` now exposes the five source import-row read previews (detail, bridge plan, index upsert, profit table, and plan lines) from one selected import; all remain read-only receipts.
...
- Browser action delta: Rabbita `/investment` now mirrors the source version-create form (name, copy-from, remark, activate) and submits only the gated candidate.
- Browser action delta: Rabbita `/investment` now mirrors the source index-create form (dimension, code, name, parent, unit, value, remark) and submits only the gated candidate.
...
- Browser action delta: Rabbita `/contracts/:guid` now mirrors the source payment-milestone create form and exposes trigger-event/delete actions for imported or command-owned rows; the native PostgreSQL gateway persists only command-owned milestone projections, while imported rows remain read-only and payment, cash, accounting, and tax effects stay disabled.
- Browser action delta: Rabbita `/payment-applies` now mirrors the source five payment views, contract-backed create form, dynamic amount/plan/node fields, eligibility check, attachment navigation, and command candidate submission. Imported payment rows remain read-only; provider, payment, cash, accounting, and tax effects remain gated.
- Browser action delta: Rabbita `/expenses/new` now mirrors the source expense header, detail row, four-dimensional split row, offset/payable balance check, project and budget-user source shortcuts, loan-balance context, dynamic draft/update/submit payloads, and budget precheck. The native PostgreSQL projection retains the source-shaped fields and command-created rows read back through the expense list/detail adapter; multi-row add/delete controls, CBS cascading selectors, attachment binary handling, and finance/accounting/tax effects remain explicitly gated.
- Browser action delta: Rabbita `/loans/new` and command-owned `/loans/:guid` now mirror the source loan header fields, project/department context, dynamic draft/update/submit lifecycle, three-state balance display, and offset candidate. Loan detail reads the source workflow instance by `processInstanceGuid`, renders the step/decision/assignee/comment trail, and loads the source attachment metadata panel; imported loans remain read-only, while attachment binaries/upload/AI operations plus cash/accounting/tax effects remain gated.
- Browser action delta: Rabbita `/dynamic-cost` now mirrors the source cost-subject create fields (code/name/level/parent and A/D/E/F/G amounts plus remarks) and submits the native source-shaped command; the live projection refreshes after persistence, while imported `cb_cost` rows and CBS/budget/cash/accounting/tax effects remain gated.
- Browser action delta: Rabbita `/dynamic-cost` now switches the live project scope, opens source-compatible cost remarks, and exports the selected projection as CSV/XLSX through existing browser/native boundaries; reads remain non-authorizing and imports remain read-only.
- Browser action delta: Rabbita `/projects/:guid` now loads the source project lifecycle timeline, eight KPI dimensions, and project anomaly cards through the native PostgreSQL dashboard endpoints; the observations remain non-authorizing and preserve the designer fallback when source data is empty.
- Browser action delta: Rabbita `/reports` now mirrors the source five-report tabs (cost, contract payment, supplier analysis, approval efficiency, and project-stage matrix), reads the nested PostgreSQL report projections, and exports the active tab as CSV without adding write authority.
- Browser action delta: Rabbita `/reports` now exposes source sharing controls (create, list, and revoke) through the native report-share projection; generated paths remain read-only and inherit expiry, revoke, forwarded-TLS, and public-serving gates.
- Browser action delta: Rabbita `/reports` now reads and updates the source `fav_reports` preference through the signed PostgreSQL preference boundary; favorite changes remain user-scoped and report-data neutral.
...
- Browser action delta: Rabbita `/srm/providers/:guid` now exposes the source-compatible supplier signature-check preview; imported suppliers stop at procurement-owner approval, while command-owned suppliers receive only a derived non-authorizing risk preview.
...
- Browser action delta: Rabbita `/tasks` now mirrors the source task tabs (pending, initiated, approval history, and warning tasks), loads PostgreSQL workflow observations and `/warning/tickets/mine`, and keeps ticket transitions explicitly local candidates; empty source rows remain visible as evidence.
...
- Browser action delta: Rabbita `/webhook-config` now mirrors the source three-platform tabs and editable enabled/URL/secret fields, sends dynamic platform-scoped configuration candidates, and keeps test/overdue-scan actions in the native dry-run boundary; credentials, external delivery, and ticket mutation remain disabled.
...
- Browser action delta: Rabbita `/users` now mirrors the source new-user form with editable account, name, initial password, company/department GUIDs, and super-user review toggle; save builds a dynamic redacted PostgreSQL RBAC candidate and keeps imported rows read-only.
- Browser action delta: command-owned users created from Rabbita `/users` now merge into the native roster and can authenticate through the PostgreSQL credential login path.
...
- Browser action delta: Rabbita `/users` now calls the native local-role assignment candidate for the imported admin identity; authorization remains a candidate only.
...
- API-state delta: `connected_auth_command_candidate` **4** now covers native login verification plus persisted logout/profile/password-transition commands. The no-credential login response remains an explicit lifecycle gate, but the browser path is connected. The API-state JSON ledger remains authoritative.
- Native additions since the original matrix snapshot: `connected_cashflow_ai_explain_candidate` **1**, `connected_investment_ai_explain_candidate` **1**, `plan_ai_suggestion_candidate` **1**, `ai_hub_explain_candidate` **1**, `ai_hub_command_candidate` **9**, `attachment_re_extract_candidate` **1**, `attachment_upload_candidate` **1**, `attachment_delete_candidate` **1**, `connected_cbs_command_candidate` **5**, `connected_cbs_approval_command_candidate` **3**, `investment_excel_index_upsert_candidate` **1**, `investment_excel_plan_line_import_candidate` **1**, `investment_subject_mappings_candidate` **1**, `investment_plan_line_update_candidate` **1**, `investment_excel_upload_candidate` **1**, `connected_loan_workflow_sync_candidate` **1**, `connected_rbac_role_command_candidate` **2**, `connected_rbac_role_assignment_candidate` **1**, `connected_warning_custom_rule_preview_candidate` **1**, `connected_supplier_rescore_command` **1**, `connected_investment_command_candidate` **6**, `connected_report_export_xlsx` **1**, `connected_tender_state_candidate` **1**, and `connected_tender_award_candidate` **1**; the JSON ledger is authoritative for the full state counts.
...
- Browser action delta: Rabbita `/marketing` now loads all four PostgreSQL resource families, switches the source project, exposes source-shaped tabs and five live KPI cards, provides editable authority-bound create forms for campaigns, placements, channels, and materials, exposes delete candidates for command-owned campaign rows, and provides a command-owned placement-effect form for impressions/clicks/leads updates. Imported rows remain read-only.
- Browser action delta: Rabbita `/fund/plan` now loads projects plus plans, gap-analysis series, and dispatch rows; project switching and the three source tabs are live, plan/dispatch creation uses editable authority-bound forms, and command-owned plan edit/delete plus pending-dispatch approval candidates are exposed. Imported rows remain read-only.
- Browser action delta: Rabbita `/invoice` now loads projects plus incoming/outgoing invoices and the tax ledger, supports project switching, mirrors all three source tabs, renders live rows and totals, provides editable authority-bound incoming/outgoing registration forms, and exposes delete/archive candidates only for command-owned rows.
- Browser action delta: Rabbita `/project/progress` now loads the project master list, scopes live ERP source progress/output rows plus overview reads to the selected project, mirrors progress/output/task-report tabs, provides source-shaped editable progress/report/output forms with project-scoped contract lookup for local command candidates, and exposes row-level progress reporting and output confirmation for command-owned rows alongside progress-row delete candidates. Imported rows remain read-only.
- Browser action delta: Rabbita `/tender` now loads the project master list, scopes source tender reads and local tender creation to the selected project, mirrors the source create-tender and award dialogs with editable fields, provider selection, source-row selection, live 招标计划/定标记录 tabs, and per-row lifecycle candidates for command-owned tenders. Imported rows remain read-only.
...
|---|---|---|---|---|---:|---|---|
| `/login` | `../views/Login.vue` | `login_view` | `public` | `auth` | 3 / 6 | `connected_auth_command_candidate` | `accept_browser_auth_command_scenario_and_security_owner` |
...
| `/expenses/new` | `../views/ExpenseCreate.vue` | `expense_editor_view` | `connected_command_form` | `budget` | 8 / 11 | `connected_expense_command` | `accept_production_identity_and_full_session_scenario` |
...
| `/payment-applies` | `../views/PaymentApplies.vue` | `payment_applies_view` | `connected_payment_application_command_form` | `cost` | 11 / 13 | `connected_payment_application_command` | `accept_browser_payment_application_scenario_and_finance_owner` |
...
| `/loans` | `../views/LoanList.vue` | `loans_view` | `connected_loan_read` | `loan` | 5 / 8 | `connected_loan_read` | `accept_browser_loan_scenario_and_production_identity` |
| `/loans/new` | `../views/LoanCreate.vue` | `loan_editor_view` | `connected_loan_command_form` | `loan` | 8 / 9 | `connected_loan_command` | `accept_browser_loan_command_scenario_and_finance_owner` |
| `/loans/:guid` | `../views/LoanDetail.vue` | `loan_editor_view` | `connected_loan_command_form` | `loan` | 8 / 10 | `connected_loan_command` | `accept_browser_loan_command_scenario_and_finance_owner` |
...
| `/project/progress` | `../views/ProjectProgress.vue` | `progress_view` | `connected_delivery_command_form` | `progress` | 4 / 5 | `connected_delivery_command` | `accept_browser_delivery_scenario_and_production_identity` |
...
| `/users` | `../views/UserManagement.vue` | `users_view` | `connected_rbac_user_read` | `rbac` | 6 / 7 | `connected_rbac_user_read` + `connected_rbac_user_command_candidate` | `accept_browser_user_roster_scenario_and_super_user_owner` |
...
| `/inbox` | `../views/Inbox.vue` | `inbox_view` | `connected_notification_read` | `notify` | 10 / 11 | `connected_notification_read` + `connected_notification_message_command` | `accept_browser_notification_scenario_and_production_identity` |
| `/notify-config` | `../views/NotifyConfig.vue` | `notify_view` | `connected_notification_read` | `notify` | 10 / 11 | `connected_notification_read` + `connected_notification_subscription_command` + `connected_notification_config_command_candidate` | `accept_browser_notification_scenario_and_production_identity` |
...
| `ai-hub` | `POST` | `/intake` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
| `ai-hub` | `POST` | `/confirm` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
| `ai-hub` | `POST` | `/discard/:draftId` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
...
| `ai-hub` | `POST` | `/query` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
...
| `ai-hub` | `POST` | `/rule-from-nl` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
| `ai-hub` | `POST` | `/approval-draft` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
| `ai-hub` | `POST` | `/global-ask` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
| `ai-hub` | `POST` | `/query-session` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
| `ai-hub` | `GET` | `/usage-stats` | `/ai-hub` | `connected_ai_hub_read` | `accept_browser_ai_hub_scenario_and_production_identity` |
| `ai-hub` | `POST` | `/command` | `/ai-hub` | `ai_hub_command_candidate` | `accept_browser_ai_hub_command_scenario_and_ai_owner` |
...
| `attachment` | `POST` | `/upload` | `/attachments` | `attachment_upload_candidate` | `accept_browser_attachment_upload_scenario_and_ai_owner` |
...
| `attachment` | `DELETE` | `/:guid` | `/attachments` | `attachment_delete_candidate` | `accept_browser_attachment_delete_scenario_and_ai_owner` |
...
| `auth` | `POST` | `/login` | `/login`, `/profile` | `connected_auth_command_candidate` | `accept_browser_auth_command_scenario_and_security_owner` |
| `auth` | `GET` | `/me` | `/login`, `/profile` | `connected_profile_read` | `accept_browser_profile_scenario_and_production_identity` |
| `auth` | `POST` | `/logout` | `/login`, `/profile` | `connected_auth_command_candidate` | `accept_browser_auth_command_scenario_and_security_owner` |
| `auth` | `POST` | `/change-password` | `/login`, `/profile` | `connected_auth_command_candidate` | `accept_browser_auth_command_scenario_and_security_owner` |
| `auth` | `PUT` | `/profile` | `/login`, `/profile` | `connected_auth_command_candidate` | `accept_browser_auth_command_scenario_and_security_owner` |
...
| `budget` | `POST` | `/expenses/:guid/sync-from-workflow` | `/expenses`, `/expenses/new`, `/expenses/:guid` | `connected_expense_workflow_sync_candidate` | `accept_workflow_source_rows_and_finance_owner` |
...
| `cbs` | `POST` | `/dict` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/dict/batch-adjust` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
...
| `cbs` | `POST` | `/versions/clone` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/versions/freeze` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/versions/activate` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
...
| `cbs` | `POST` | `/r0/resolve` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
...
| `cbs` | `POST` | `/demo/contracts` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `PUT` | `/demo/contracts/:id/state` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/demo/legacy` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `DELETE` | `/demo/clear` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/submit-approval` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/approve` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/reject` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/mark-paid` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
...
| `cbs` | `POST` | `/changes` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/changes/:id/submit-approval` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/changes/:id/approve` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `POST` | `/approval-rules` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_approval_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `PUT` | `/approval-rules/:guid` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_approval_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
| `cbs` | `DELETE` | `/approval-rules/:guid` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `connected_cbs_approval_command_candidate` | `accept_browser_cbs_command_scenario_and_finance_owner` |
...
| `investment` | `POST` | `/excel-imports/:importGuid/plan-lines/import` | `/investment` | `investment_excel_plan_line_import_candidate` | `accept_browser_investment_excel_scenario_and_investment_owner` |
...
| `investment` | `PUT` | `/plan-lines/:lineGuid` | `/investment` | `investment_plan_line_update_candidate` | `accept_browser_investment_excel_scenario_and_investment_owner` |
...
| `investment` | `PUT` | `/projects/:projGuid/subject-mappings` | `/investment` | `investment_subject_mappings_candidate` | `accept_browser_investment_excel_scenario_and_investment_owner` |
...
| `loan` | `POST` | `/loans/:guid/sync-from-workflow` | `/loans`, `/loans/new`, `/loans/:guid` | `connected_loan_workflow_sync_candidate` | `accept_workflow_source_rows_and_loan_owner` |
...
| `rbac` | `POST` | `/users` | `/users` | `connected_rbac_user_command_candidate` | `accept_browser_user_command_scenario_and_identity_owner` (Rabbita local-user action now wired) |
| `rbac` | `PUT` | `/users/:userId` | `/users` | `connected_rbac_user_command_candidate` | `accept_browser_user_command_scenario_and_identity_owner` (Rabbita candidate action now wired) |
| `rbac` | `POST` | `/users/:userId/toggle` | `/users` | `connected_rbac_user_command_candidate` | `accept_browser_user_command_scenario_and_identity_owner` (Rabbita candidate action now wired) |
| `rbac` | `POST` | `/users/:userId/reset-password` | `/users` | `connected_rbac_user_command_candidate` | `accept_browser_user_command_scenario_and_identity_owner` (Rabbita candidate action now wired) |
| `rbac` | `POST` | `/users/:userId/roles` | `/users` | `connected_rbac_role_assignment_candidate` | `accept_browser_user_command_scenario_and_identity_owner` (Rabbita assignment action now wired) |
...
| `rbac` | `DELETE` | `/roles/:code` | `/users` | `connected_rbac_role_command_candidate` | `accept_browser_user_command_scenario_and_identity_owner` (Rabbita local-role action now wired) |
...
| `sales` | `DELETE` | `/customers/:guid` | `/sales/revenues`, `/sales/customers`, `/sales/subscriptions`, `/sales/contracts`, `/sales/mortgages` | `connected_sales_command` | `accept_browser_sales_command_scenario_and_sales_finance_owner` |
...
| `warning` | `POST` | `/scan` | `/warning`, `/warning-rules` | `connected_warning_scan_preview_read` | `accept_browser_warning_scan_preview_scenario_and_warning_owner` (Rabbita dry-run action now wired) |
