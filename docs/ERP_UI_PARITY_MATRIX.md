...
- API-state delta: `connected_import_batch_command_candidate` **1** now covers project and contract command paths; `sales_customer_delete_candidate` **1** remains an authenticated policy gate. The API-state JSON ledger remains authoritative.
