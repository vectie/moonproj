...
- Browser action delta: Rabbita `/attachments` now calls the native OCR re-extraction candidate; binary access, OCR/provider execution, metadata persistence, and deletion remain disabled.
