...
- API-state delta: `connected_auth_command_candidate` **3** now covers persisted logout/profile/password-transition commands; `auth_lifecycle_candidate` **1** remains for the login gate. The API-state JSON ledger remains authoritative.
