...
- Browser action delta: Rabbita `/notify-config` now exposes email test and redelivery candidates; the trusted gateway preserves redaction and missing-imported-row boundaries without queueing or sending mail.
