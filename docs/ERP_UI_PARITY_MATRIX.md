...
- Native additions since the original matrix snapshot: `connected_investment_command_candidate` **6** and `connected_report_export_xlsx` **1**; the JSON ledger is authoritative for the full state counts.
