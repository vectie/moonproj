...
- API-state delta: `connected_import_batch_command_candidate` **1** now covers the project command path while the contract route remains an explicit `import_batch_candidate` gate; `sales_customer_delete_candidate` **1** also remains an authenticated policy gate. The API-state JSON ledger remains authoritative.
...
| `cbs` | `POST` | `/r0/resolve` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
...
| `cbs` | `POST` | `/demo/contracts` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `PUT` | `/demo/contracts/:id/state` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/demo/legacy` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `DELETE` | `/demo/clear` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/submit-approval` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/approve` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/reject` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/contracts/:id/mark-paid` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
...
| `cbs` | `POST` | `/changes` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/changes/:id/submit-approval` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
| `cbs` | `POST` | `/changes/:id/approve` | `/cbs/dict`, `/cbs/versions`, `/cbs/r0-queue`, `/cbs/approval-config` | `cbs_mutation_boundary_candidate` | `accept_browser_cbs_mutation_scenario_and_finance_owner` |
...
| `import` | `POST` | `/:bizType` | — | `connected_import_batch_command_candidate` | `implement_contract_batch_transaction_and_accept_import_owner` |
...
| `sales` | `DELETE` | `/customers/:guid` | `/sales/revenues`, `/sales/customers`, `/sales/subscriptions`, `/sales/contracts`, `/sales/mortgages` | `sales_customer_delete_candidate` | `accept_sales_archive_or_destructive_delete_policy` |
