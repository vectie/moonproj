...
- Target states: `{"connected_admin_health_read": 1, "connected_admin_read": 1, "connected_command_form": 1, "connected_contract_command_form": 1, "connected_contract_read": 1, "connected_delivery_command_form": 2, "connected_investment_read": 1, "connected_invoice_read": 1, "connected_loan_command_form": 2, "connected_loan_read": 1, "connected_payment_application_command_form": 1, "connected_project_read": 2, "connected_report_read": 1, "connected_sales_read": 5, "connected_supplier_command_form": 1, "connected_tender_command_form": 1, "connected_workflow_definition_read": 1, "fixture_backed_form": 2, "fixture_backed_read_only": 25, "public": 1, "read_model_only": 3, "read_only_public": 1}`
- API states: `{"connected_admin_health_read": 1, "connected_admin_read": 1, "connected_contract_command": 2, "connected_delivery_command": 2, "connected_expense_command": 1, "connected_fixed_read_model": 3, "connected_investment_read": 1, "connected_invoice_read": 1, "connected_loan_command": 2, "connected_loan_read": 1, "connected_payment_application_command": 1, "connected_project_read": 2, "connected_report_read": 1, "connected_sales_read": 5, "connected_supplier_command": 1, "connected_tender_command": 1, "connected_workflow_definition_read": 1, "read_only_fixture_no_source_api": 29}`
...
| `/cashflow` | `../views/CashflowForecast.vue` | `cashflow_view` | `fixture_backed_read_only` | `cashflow` | 6 / 1 | `read_only_fixture_no_source_api` | `connect_authenticated_read_api_and_accept_screenshot_and_scenario` |
...
| `/audit-log` | `../views/AuditLog.vue` | `audit_view` | `fixture_backed_read_only` | `admin` | 13 / 5 | `read_only_fixture_no_source_api` | `connect_authenticated_read_api_and_accept_screenshot_and_scenario` |
...
| `/users` | `../views/UserManagement.vue` | `users_view` | `fixture_backed_read_only` | `rbac` | 5 / 7 | `read_only_fixture_no_source_api` | `connect_authenticated_read_api_and_accept_screenshot_and_scenario` |
...
| `auth` | `GET` | `/my-initiated` | `/login`, `/profile` | `not_connected` | `connect_authenticated_read_api` |
...
| `cashflow` | `GET` | `/forecast` | `/cashflow` | `not_connected` | `connect_authenticated_read_api` |
