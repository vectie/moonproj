...
`PUT /api/company/source/cost/contracts/:guid` and `DELETE .../:guid` handlers
now translate into the native PostgreSQL contract projection. Updates are
